...
CREATE TABLE `qrtz_blob_triggers` (
  `SCHED_NAME` varchar(80) COLLATE utf8_bin NOT NULL,
  `TRIGGER_NAME` varchar(100) COLLATE utf8_bin NOT NULL,
  `TRIGGER_GROUP` varchar(100) COLLATE utf8_bin NOT NULL,
  `BLOB_DATA` blob,
...
CREATE TABLE `qrtz_calendars` (
  `SCHED_NAME` varchar(80) COLLATE utf8_bin NOT NULL,
  `CALENDAR_NAME` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `qrtz_fired_triggers` (
  ...
  `JOB_GROUP` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `qrtz_job_details` (
  ...
  `JOB_CLASS_NAME` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `qrtz_simprop_triggers` (
  ...
  `TRIGGER_NAME` varchar(100) COLLATE utf8_bin NOT NULL,
  `TRIGGER_GROUP` varchar(100) COLLATE utf8_bin NOT NULL,
  `STR_PROP_1` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `STR_PROP_2` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `STR_PROP_3` varchar(120) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `qrtz_triggers` (
  ...
  `CALENDAR_NAME` varchar(100) COLLATE utf8_bin DEFAULT NULL,
