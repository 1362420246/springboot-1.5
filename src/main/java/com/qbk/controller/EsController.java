...
import com.qbk.entity.EsModel;
import com.qbk.util.ElasticsearchUtil;
import com.qbk.util.EsPage;
...
public class EsController {
    ...
    public String insertJson() {
        ...
        jsonObject.put("id", DateFormatUtils.format(new Date(),"yyyy-MM-dd"));
    ...
    public String insertModel() {
        ...
        esModel.setId( DateFormatUtils.format(new Date(),"yyyy-MM-dd"));
